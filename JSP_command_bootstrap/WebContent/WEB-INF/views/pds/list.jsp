	  		...
	  		<div class="row md-2">
	  			...
	  			<div class="col-sm-6">
			        ...
			        <li class="breadcrumb-item">
			        	<a href="list.do">
				        	<i class="fa fa-dashboard"></i>자료목록
				        </a>
			        </li>
				...
				<table class="table table-bordered text-center" >					
					...
					<c:forEach items="${pdsList }" var="pds">
						<tr style='font-size:0.85em;'>
							...
							<a href="javascript:OpenWindow('detail.do?bno=${pds.pno }','상세보기',800,700);">
								<span class="col-sm-12 ">${pds.title }
									<c:if test="${pds.replycnt ne 0 }">		
										<span class="nav-item">															
										&nbsp;&nbsp;<i class="fa fa-comment"></i>
										<span class="badge badge-warning navbar-badge">${pds.replycnt}</span>
										</span>
