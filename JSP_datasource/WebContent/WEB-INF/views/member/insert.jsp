...
<body>
	...
	<form action="insert" method="post">
		<table>
			<tr>
				<td>아이디 :</td>
				<td><input type="text" class="" id="id" name="id" value=""></td>
			</tr>
			<tr>
				<td>패스워드 :</td>
			...
			<tr>
				<td>이름 :</td>
				<td><input type="text" class="" id="name" name="name" value=""></td>
			</tr>
			<tr>
				<td>전화번호 :</td>
		...
		<input id="sendBtn" type="submit" class="btn btn-primary" value="회원가입">
	</form>
