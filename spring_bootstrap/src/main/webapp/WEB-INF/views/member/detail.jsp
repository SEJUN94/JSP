					...
					<div class="register-card-body">
						<div class="row" style="height: 200px;">
							<div class="mailbox-attachments clearfix col-md-12"
								...
								<div class="manPicture" id="pictureView" data-id="${member.id }"
							...
							<div id="isMemberList" style="display:none;">
								...
								<div class="col-sm-3 text-center">
									<c:if test="${member.enabled ne 0 }">
										<button type="button"
											onclick="location.href='enabled.do?id=${member.id}&enabled=0';"
											id="stopBtn" class="btn btn-info">비활성</button>
									</c:if>
									<c:if test="${member.enabled eq 0 }">
										<button type="button"
											onclick="location.href='enabled.do?id=${member.id}&enabled=1';"
